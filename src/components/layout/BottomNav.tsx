...
export function BottomNav({ onMenuClick }: BottomNavProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t lg:hidden safe-area-pb">
      <div className="flex items-center justify-around h-16">
        ...
        <button
          onClick={onMenuClick}
          className="flex flex-col items-center justify-center min-w-[64px] h-11 px-3 rounded-lg text-gray-500 hover:text-gray-700 transition-colors"
        >
